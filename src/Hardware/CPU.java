...
public class CPU {
    ...
    public CPU(Memory _mem, InterruptHandling _ih, SysCallHandling _sysCall, boolean _debug, int _partitionSize) {
    ...
    public void setContext(int _base, int _limite, int _pc, int _particao) {
        base = _base;
        limite = _limite;
        pc = _pc;
        irpt = Interrupts.noInterrupt;
    ...
    public int convertePosicaoMemoria(int posicao){
        if (legal(posicao)){
            posicao = posicao+(particao*partitionSize);
            return posicao;
        }
        System.out.println("Erro ao converter posicao da memoria: " + posicao);
